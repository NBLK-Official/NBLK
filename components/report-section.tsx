...
Please provide detailed, actionable insights that demonstrate the value of professional business consulting. Use professional business language appropriate for C-level executives and business owners.`
      ...
      const response = await fetch("https://api.openai.com/v1/chat/completions", {
        ...
        headers: {
          ...
          Authorization:
            "Bearer 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",
        },
        body: JSON.stringify({
          model: "gpt-3.5-turbo",
          messages: [
